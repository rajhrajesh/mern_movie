...
export const useAuthStore = create((set) => (
    {
        ...
        logout: async () => {
          ...
          try {
              await axios.post('https://mern-movie-netflix-junior.onrender.com/api/v1/users/logout');
      ...
      myprofile: async () => {
        ...
        try {
          const response = await axios.get('https://mern-movie-netflix-junior.onrender.com/api/v1/users/myprofile');
