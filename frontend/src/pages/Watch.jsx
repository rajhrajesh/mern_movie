...
function Watch() {
    ...
    useEffect(() => {
		const getTrailers = async () => {
			try {
				const res = await axios.get(`https://mern-movie-netflix-junior.onrender.com/api/v1/${contentType}/${id}/trailers`);
    ...
    useEffect(() => {
		const getSimilarContent = async () => {
			try {
				const res = await axios.get(`https://mern-movie-netflix-junior.onrender.com/api/v1/${contentType}/${id}/similar`);
    ...
    useEffect(() => {
		const getContentDetails = async () => {
			try {
				const res = await axios.get(`https://mern-movie-netflix-junior.onrender.com/api/v1/${contentType}/${id}/details`);
			...
			<div className='mx-auto container px-4 py-8 h-full'>
				...
				{trailers.length > 0 && (
					<div className='flex justify-between items-center mb-4'>
						<button
							className={`
							bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded-lg ${
