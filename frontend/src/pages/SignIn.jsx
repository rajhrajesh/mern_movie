        ...
        <div className='w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md'>
          ...
          <form className='space-y-4' onSubmit={handleSubmit}>
            <div>
              ...
              <input type='email' id='email' className='w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white focus:outline-none focus:ring' placeholder='rajesh@gmail.com' required onChange={(e) => setEmail(e.target.value)}/>
            </div>
            <div>
              <label htmlFor='username' className='text-sm font-medium text-gray-300 block'>Username</label>
              <input type='text' id='username' className='w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white focus:outline-none focus:ring' placeholder='rajhrajesh' required onChange={(e) => setUsername(e.target.value)}/>
            </div>
            <div>
